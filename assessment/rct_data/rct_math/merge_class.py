...
#try:
fp_2011_12=csv.reader(open('/home/brijesh/rct_math_4std.csv','r'),delimiter='|',quotechar='\'')
fp_2012_13=csv.reader(open('/home/brijesh/rct_math_5std.csv','r'),delimiter='|',quotechar='\'')
