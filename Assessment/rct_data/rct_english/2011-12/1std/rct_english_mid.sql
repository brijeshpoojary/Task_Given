...
case when ans.status=-99999 then '99' else case when ans.status=-1 then '0' else case when ans."answerGrade"='' then '0' else cast(ans."answerGrade" as text) end end end as answergrade 
from 
