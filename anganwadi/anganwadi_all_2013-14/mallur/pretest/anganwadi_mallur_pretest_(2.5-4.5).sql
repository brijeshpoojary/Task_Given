...
case when ans.status=-99999 then '99' else case when ans.status=-1 then '0' else case when ans.answer_grade=' ' then '0' else cast(ans.answer_grade as text) end end end as answerscore 
from 
