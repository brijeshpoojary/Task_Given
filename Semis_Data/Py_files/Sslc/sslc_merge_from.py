...
try:
    ...
    result="select distinct district_code,school_code,schoolname from tb_sslcresults"
    
    cur.execute(result)

    #Opening a file with specified headers and adding the data into csv file
    fp=csv.writer(open('/home/brijesh/klp/Task_One/sslc.csv','w'),delimiter='|',quotechar='\'')
